            ...
            {competences.map((competence, index) => (
                <div className="grid w-full max-w-3xl gap-3 justify-self-center px-4 py-5 font-poppins text-lg font-semibold" key={competence.id || index}>
                    ...
                    <div className="grid justify-items-end gap-4 font-normal">
                        ...
                        <span className="flex w-full items-center gap-3 rounded-3xl bg-gray-light px-3 py-3 text-gray-dark">
                            <span className="ml-2 w-full text-left">{competence.activite1}</span>
                        ...
                        <span className="flex w-full items-center gap-3 rounded-3xl bg-gray-light px-3 py-3 text-gray-dark">
                            <span className="ml-2 w-full text-left">{competence.activite2}</span>
                            <span className="flex gap-2">
